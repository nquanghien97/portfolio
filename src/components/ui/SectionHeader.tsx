...
export function SectionHeader({
  ...
  return (
    ...
    >
      {label && (
        <div className="inline-flex items-center gap-1.5 mb-4 border border-accent/30 px-4 py-2 rounded-full bg-accent/5">
          <span className="text-white text-xs tracking-wide">{`///`}</span>
